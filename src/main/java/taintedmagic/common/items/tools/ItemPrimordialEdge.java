...
public class ItemPrimordialEdge extends ItemSword implements IWarpingGear, IRepairable
{
    ...
    public void onUsingTick(ItemStack s, EntityPlayer p, int count)
    {
        ...
        List ents = p.worldObj.getEntitiesWithinAABB(Entity.class, AxisAlignedBB.getBoundingBox(p.posX, p.posY,
                p.posZ, p.posX + 1, p.posY + 1, p.posZ + 1).expand(15.0D, 15.0D, 15.0D));
