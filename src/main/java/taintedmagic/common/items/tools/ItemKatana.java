...
public class ItemKatana extends Item implements IWarpingGear, IRepairable, IRenderInventoryItem, IHeldItemHUD
{
    ...
    public static final ResourceLocation textureThaumium = new ResourceLocation("taintedmagic:textures/models" +
            "/ModelKatanaThaumium.png");
    public static final ResourceLocation textureVoidmetal = new ResourceLocation("taintedmagic:textures/models" +
            "/ModelKatanaVoidmetal.png");
    public static final ResourceLocation textureShadowmetal = new ResourceLocation("taintedmagic:textures/models" +
            "/ModelKatanaShadowmetal.png");
        ...
        if (!e.worldObj.isRemote && (!(e instanceof EntityPlayer) || !(p instanceof EntityPlayer) || MinecraftServer.getServer().isPVPEnabled()))
        {
            ...
            if (hasAnyInscription(s))
            {
                switch (getInscription(s))
                {
                    ...
                    case 2:
                    {
                        e.attackEntityFrom(DamageSource.wither.setMagicDamage().setDamageBypassesArmor(),
                                getAttackDamage(s));
