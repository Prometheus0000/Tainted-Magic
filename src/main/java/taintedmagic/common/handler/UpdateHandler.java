    ...
    public static void init()
    {
        ...
        if (newestVersion != null)
        {
            ...
            else if (!newestVersion.equalsIgnoreCase(currentVersion))
            {
                show = true;
                updateStatus =
                        (EnumChatFormatting.RED + "Tainted Magic is out of date! The latest version is " + EnumChatFormatting.GREEN + newestVersion);
                TaintedMagic.log.info("Mod out of date! You're still running: " + currentVersion + ", Latest Version:" +
                        " " + newestVersion);
            }
        }
        else
