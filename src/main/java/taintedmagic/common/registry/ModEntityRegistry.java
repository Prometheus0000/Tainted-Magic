...
public class ModEntityRegistry
{
    ...
    {
        int ID = 0;
        EntityRegistry.registerModEntity(EntityTaintBubble.class, "EntityTaintBubble", ID++, TaintedMagic.instance,
                64, 20, true);
        EntityRegistry.registerModEntity(EntityDarkMatter.class, "EntityDarkMatter", ID++, TaintedMagic.instance, 64,
                21, true);
        EntityRegistry.registerModEntity(EntityHomingShard.class, "EntityHomingShard", ID++, TaintedMagic.instance,
                64, 3, true);
        EntityRegistry.registerModEntity(EntityGlowpet.class, "EntityGlowpet", ID++, TaintedMagic.instance, 64, 3,
                true);
